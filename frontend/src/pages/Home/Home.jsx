...
const Home = () => {
  ...
  const getAllNotes = async () => {
    try {
      const res = await axios.get("note-app-backend-lilac.vercel.app/api/note/all", {
  ...
  const deleteNote = async (data) => {
    ...
    try {
      const res = await axios.delete(
        "note-app-backend-lilac.vercel.app/api/note/delete/" + noteId,
        { withCredentials: true }
      )
  ...
  const onSearchNote = async (query) => {
    try {
      const res = await axios.get("note-app-backend-lilac.vercel.app/api/note/search", {
        params: { query },
        withCredentials: true,
      })
  ...
  const updateIsPinned = async (noteData) => {
    ...
    try {
      const res = await axios.put(
        "note-app-backend-lilac.vercel.app/api/note/update-note-pinned/" + noteId,
