...
const Home = () => {
  ...
  const getAllNotes = async () => {
    try {
      const res = await axios.get("https://note-app-peb5-dmhrciya1-gautam5514s-projects.vercel.app/api/note/all", {
  ...
  const deleteNote = async (data) => {
    ...
    try {
      const res = await axios.delete(
        "https://note-app-peb5-dmhrciya1-gautam5514s-projects.vercel.app/api/note/delete/" + noteId,
        { withCredentials: true }
      )
  ...
  const onSearchNote = async (query) => {
    try {
      const res = await axios.get("https://note-app-peb5-dmhrciya1-gautam5514s-projects.vercel.app/api/note/search", {
        params: { query },
        withCredentials: true,
      })
  ...
  const updateIsPinned = async (noteData) => {
    ...
    try {
      const res = await axios.put(
        "https://note-app-peb5-dmhrciya1-gautam5514s-projects.vercel.app/api/note/update-note-pinned/" + noteId,
